...
/**
 * @file
 * @brief ESP BSP: ESP32-P4-WIFI6-DB-POE-ETH
 */
 ...
 *  @{
 */
#define BSP_BOARD_ESP32_P4_WIFI6_DB_POE_ETH
/** @} */ // end of boardname
...
/** @brief ESP32-C5 Hosted SDIO wiring. Configure the transport in the application. */
#define BSP_WIFI_SDIO_CLK       (GPIO_NUM_18)
#define BSP_WIFI_SDIO_CMD       (GPIO_NUM_19)
#define BSP_WIFI_SDIO_D0        (GPIO_NUM_14)
#define BSP_WIFI_SDIO_D1        (GPIO_NUM_15)
#define BSP_WIFI_SDIO_D2        (GPIO_NUM_16)
#define BSP_WIFI_SDIO_D3        (GPIO_NUM_17)
#define BSP_WIFI_RST            (GPIO_NUM_54)
#define BSP_WIFI_RST_ACTIVE_LEVEL (0)
#define BSP_WIFI_SDIO_SLOT      (1)
 ...
 * @param[in]  i2s_config I2S configuration. Pass NULL to use default values (Mono, duplex, 16bit, 48000 Hz)
 * @return
 *      - ESP_OK                On success
