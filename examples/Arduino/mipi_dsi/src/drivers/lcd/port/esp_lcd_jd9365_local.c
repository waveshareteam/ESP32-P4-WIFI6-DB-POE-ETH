...
#include "esp_lcd_jd9365_local.h"
#include <stdio.h>
...
static const char *TAG = "jd9365_local";
...
esp_err_t esp_lcd_new_panel_jd9365_local(const esp_lcd_panel_io_handle_t io, const esp_lcd_panel_dev_config_t *panel_dev_config,
                                   esp_lcd_panel_handle_t *ret_panel)
{
    ESP_LOGI(TAG, "version: %d.%d.%d", ESP_LCD_JD9365_LOCAL_VER_MAJOR, ESP_LCD_JD9365_LOCAL_VER_MINOR,
             ESP_LCD_JD9365_LOCAL_VER_PATCH);
...
static const esp_panel_lcd_vendor_init_cmd_t vendor_specific_init_default[] = {
    ...
    {0x29, (uint8_t[]){0x00}, 1, 120},
    {0x35, (uint8_t[]){0x00}, 1, 0},
#elif CONFIG_BSP_LCD_TYPE_800_1280_10_1_INCH_A || CONFIG_BSP_LCD_TYPE_800_1280_8_INCH_A
    {0xE0, (uint8_t[]){0x00}, 1, 0},
    {0xE1, (uint8_t[]){0x93}, 1, 0},
    {0xE2, (uint8_t[]){0x65}, 1, 0},
    {0xE3, (uint8_t[]){0xF8}, 1, 0},
...
static esp_err_t panel_jd9365_init(esp_lcd_panel_t *panel)
{
    ...
    printf("LCD: JD9365 read-ID transaction done, ID=%02X %02X %02X\n", ID[0], ID[1], ID[2]);
    fflush(stdout);
    ...
    printf("LCD: JD9365 vendor command sequence begin, count=%u\n", (unsigned)init_cmds_size);
    fflush(stdout);
