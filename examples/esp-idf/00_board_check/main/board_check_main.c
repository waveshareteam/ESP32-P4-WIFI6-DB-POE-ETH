...
void app_main(void)
{
    ...
    printf("Next steps:\n");
    printf("  1. Run 01_i2c_tools to scan the I2C bus.\n");
    printf("  2. Run 02_sdmmc to verify the SD card path, if present.\n");
    printf("  3. Choose the other examples under examples/esp_idf based on your board.\n");
    printf("\n");
