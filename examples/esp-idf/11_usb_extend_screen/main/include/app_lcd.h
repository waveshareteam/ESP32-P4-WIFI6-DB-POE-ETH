...
#if EXAMPLE_LCD_H_RES != BSP_LCD_H_RES || EXAMPLE_LCD_V_RES != BSP_LCD_V_RES
#error "USB screen dimensions must match the BSP panel; regenerate the project configuration"
#endif
#endif
