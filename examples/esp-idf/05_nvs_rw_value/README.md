...
This example demonstrates how to read and write NVS values. On every boot, it
reads the saved boot counter, starts from zero when the key is absent, increments
the counter, and saves the new value.
...
I (296) nvs_example:
Reading saved boot counter...
I (306) nvs_example:
No saved boot counter. Starting from zero.
I (306) nvs_example:
Writing boot counter to NVS...
I (306) nvs_example: Boot count: 1
I (306) nvs_example:
