...
def test_examples_nvs_rw_value(dut: Dut) -> None:
    ...
    dut.expect('Reading saved boot counter...', timeout=20)
    dut.expect('No saved boot counter. Starting from zero.', timeout=20)
    dut.expect('Writing boot counter to NVS...', timeout=20)
    dut.expect('Boot count: 1', timeout=20)
    ...
    dut.expect('Boot count: 2', timeout=20)
